...
class Auth {
  ...
  async signIn(userData) {
    ...
    if (data.user.newUser == true) {
      // new user! redirect to guide page
...
class UserAPI {
  ...
  async addPastryOrder(orderId) {
    // validate
    if (!orderId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addPastryOrder"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"PastryAPI.js":[function(require,module,exports) {
"use strict";
...
class PastryAPI {
  async getPastries() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/pastry"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem getting pastries');
    } // convert response payload into json - store as data
...
var _default = new PastryAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/pastries.js":[function(require,module,exports) {
"use strict";
...
var _PastryAPI = _interopRequireDefault(require("./../../PastryAPI"));
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"Pastries\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        \n        <div class=\"pastries-grid\">\n        ", "\n\n        </div>\n        \n      </div>      \n    "]);
...
class PastriesView {
  ...
  async getPastries() {
    try {
      this.pastries = await _PastryAPI.default.getPastries();
...
var _pastries = _interopRequireDefault(require("./views/pages/pastries"));
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"components/va-pastry.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-pastry', class Pastry extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  async addOrdHandler() {
    try {
      await _UserAPI.default.addPastryOrder(this.id);

      _Toast.default.show('Order placed successfully');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-pastry":"components/va-pastry.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
